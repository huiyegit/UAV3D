...
class PolicyNet4(nn.Module):
    def __init__(self, in_channels=13, input_feat_sz=32):
        ...
        # Encoder
        # down 1
        self.conv1 = Conv2DBatchNormRelu(384, 256, k_size=3, stride=1, padding=1)
        self.conv2 = Conv2DBatchNormRelu(256, 256, k_size=3, stride=1, padding=1)
        self.conv3 = Conv2DBatchNormRelu(256, 128, k_size=3, stride=2, padding=1)
        ...
        # down 4
        # self.conv8 = Conv2DBatchNormRelu(256, 256, k_size=3, stride=1, padding=1)
        # self.conv9 = Conv2DBatchNormRelu(256, 256, k_size=3, stride=2, padding=1)
        
        # down 5
        # self.conv10 = Conv2DBatchNormRelu(256, 256, k_size=3, stride=1, padding=1)
        # self.conv11 = Conv2DBatchNormRelu(256, 256, k_size=3, stride=2, padding=1)
        
        # down 6
        # self.conv12 = Conv2DBatchNormRelu(256, 256, k_size=3, stride=1, padding=1)
        # self.conv13 = Conv2DBatchNormRelu(256, 256, k_size=3, stride=2, padding=1)
...
class KmGenerator(nn.Module):
    def __init__(self, out_size=128, input_feat_sz=32.0):
        ...
        # feat_map_sz = input_feat_sz // 4
        feat_map_sz_h = int(16 // 8)
        feat_map_sz_w = int(44 // 8)
        self.n_feat = int(128 * feat_map_sz_h * feat_map_sz_w)
