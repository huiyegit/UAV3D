...
def parse_args():
    ...
    #parser.add_argument("--root", type=str, default="/dataset/nuscenes")
    parser.add_argument("--root", type=str, default="/home/hye/yh/dataset/gsu-uav/gsu_2_1/town_all/")
...
def eval(res_path, eval_set="val", output_dir=None, root_path=None):
    ...
    from projects.evaluate import TrackingEval
