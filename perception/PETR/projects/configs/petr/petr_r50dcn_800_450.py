...
point_cloud_range = [-102.4, -102.4, -10.0, 102.4, 102.4, 10.0]
voxel_size = [0.2, 0.2, 8]
voxel_size = [0.2, 0.2, 15]
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        position_range=[-102.4, -102.4, -10.0, 102.4, 102.4, 10.0],
        normedlinear=False,
        transformer=dict(
        ...
        bbox_coder=dict(
            ...
            post_center_range=[-102.4, -102.4, -10.0, 102.4, 102.4, 10.0],
...
train_pipeline = [
    ...
    dict(type='PadMultiViewImage', size_divisor=10),
    dict(type='DefaultFormatBundle3D', class_names=class_names),
    dict(type='Collect3D', keys=['gt_bboxes_3d', 'gt_labels_3d', 'img'],
         meta_keys=['lidar_aug_matrix','img_aug_matrix','cam2lidar', 'intrinsics','extrinsics','filename', 'ori_shape', 'img_shape', 'lidar2img',
        'depth2img', 'cam2img', 'pad_shape', 'scale_factor', 'flip', 'pcd_horizontal_flip',
        'pcd_vertical_flip', 'box_mode_3d', 'box_type_3d', 'img_norm_cfg', 'pcd_trans', 'sample_idx',
        'pcd_scale_factor', 'pcd_rotation', 'pts_filename', 'transformation_3d_flow'])
    # dict(type='Collect3D', keys=['gt_bboxes_3d', 'gt_labels_3d', 'img'])
]
test_pipeline = [
    dict(type='LoadMultiViewImageFromFiles', to_float32=True),
    ...
    dict(
        ...
        transforms=[
            ...
            dict(type='Collect3D', keys=['img'],
                 meta_keys=['lidar_aug_matrix','img_aug_matrix', 'cam2lidar', 'intrinsics', 'extrinsics', 'filename', 'ori_shape', 'img_shape', 'lidar2img',
                            'depth2img', 'cam2img', 'pad_shape', 'scale_factor', 'flip', 'pcd_horizontal_flip',
                            'pcd_vertical_flip', 'box_mode_3d', 'box_type_3d', 'img_norm_cfg', 'pcd_trans',
