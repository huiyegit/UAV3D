...
val_split = ['scene_01','scene_02','scene_11','scene_12']
test_split = ['scene_01','scene_02','scene_11','scene_12']
...
def _fill_trainval_infos(nusc,
    ...
    for sample in mmcv.track_iter_progress(nusc.sample):
        ...
        for cam in camera_types:
            ...
            if './' in cam_path:
                cam_splits = cam_path.split('./')
                cam_split = './' + cam_splits[-1]
                cam_info['data_path'] = cam_split
