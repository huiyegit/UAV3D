...
class BEVFusion(Base3DFusionModel):
    ...
    def get_kd_loss(self, batch_size, num_agent, x_t1, x_t3, x_t4, x_fuse, x_3, x_4, kd_weight=100000):
        ...
        BN,C,H,W = x_t1.size()
        x_t1 = x_t1.view(batch_size, num_agent, C, H, W)
        ...
        x_fuse = x_fuse.view(batch_size, num_agent, C, H, W)
        ...
        BN,C,H,W = x_t3.size()
        x_t3 = x_t3.view(batch_size, num_agent, C, H, W)
        ...
        BN,C,H,W = x_3.size()
        x_3 = x_3.view(batch_size, num_agent, C, H, W)
        ...
        BN,C,H,W = x_t4.size()
        x_t4 = x_t4.view(batch_size, num_agent, C, H, W)
        ...
        BN,C,H,W = x_4.size()
        x_4 = x_4.view(batch_size, num_agent, C, H, W)
